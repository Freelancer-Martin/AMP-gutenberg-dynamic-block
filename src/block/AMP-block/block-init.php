...
class AMP_Block_Validated_URL_Post_Type
{
  ...
  public static function display_validated_taxonomy( $attributes, $content )
  {
  ...
  public function getHtmlOutput(  )
  {
    ...
    $array = $this->display_validated_post_types( '', '' );
    ...
    $taxonomy_array = $this->display_validated_taxonomy( '', '' );
    $container .= '';
    $container .= '<table>';
  ...
  public function AMP_Block_Dynamic() {
      ...
      register_block_type( 'gutenberg-examples/example-dynamic', array(
          ...
          'render_callback' => array( $this, 'getHtmlOutput' ),
      ) );
  ...
  public function run()
  {
      add_action( 'init', array( $this, 'AMP_Block_Dynamic' ) );
